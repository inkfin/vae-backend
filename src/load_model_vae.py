...
def interp_vae(vae: VAE, image_list, n, idx1, idx2):
...
if __name__ == "__main__":
    ...
    # plt.axis("off")
    # plt.imshow(image1, bbox_inches='tight', pad_inches=0)
    # plt.show()

    # load from faces_output_pick
    image1 = imageio.imread("../faces_output_pick/17.png")
    image2 = imageio.imread("../faces_output_pick/18.png")

    image1 = resize(image1, (IMAGE_SIZE, IMAGE_SIZE))[..., :3]
    image2 = resize(image2, (IMAGE_SIZE, IMAGE_SIZE))[..., :3]
